...
contract ERC20 is IERC20 {
    ...
    function sendTokensToCrowdsale(uint256 _tokens, address _address)
        onlyOwner
        returns (bool ok)
    {
        require(_balances[this] >= _tokens);
...
{
    constructor()
        ERC20(1000000000000000000000000000)
        ERC20Detailed("Law Block token", "LBT", 18)
