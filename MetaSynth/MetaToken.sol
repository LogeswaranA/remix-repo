...
contract XRC20Template {
    ...
    function transferFrom(
        ...
        require(
            ...
            "Error : Not enough tokens in owners account"
        );
        require(
        ...
        returns (bool)
    {
        ...
        require(
            allowed[msg.sender][_spender] >= _value,
            "Error : Not enough allowance to decrease"
        );
        allowed[msg.sender][_spender] -= _value;
        emit Approved(msg.sender, _spender, _value);
        return true;
...
contract MetaToken is XRC20Template {
    constructor(uint256 _amount, uint8 _decimal)
        XRC20Template("MetaToken", "METZ", _decimal)
    {
