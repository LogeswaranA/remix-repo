...
contract WeatherStakingFarm is Operator {
    ...
    //Apothem PLI address - xdcb3db178db835b4dfcb4149b2161644058393267d
    //Mainnet PLI address - xdcff7412ea7c8445c46a8254dfb557ac1e48094391

    function initialize(Plugin _pluginToken,address _xdcholder) public initializer {
        name = "Plugin Weather Unit Staking Farm";
        xdcholder = address(_xdcholder);
    ...
    function addXdc() public payable {
        ...
        XDCInContract = XDCInContract.add(msg.value);
    }
    ...
    function releaseXDC(address _to, string _weatheraddress) public payable{
        ...
        //XDC in Conract 
        XDCInContract = XDCInContract.sub(balance);
